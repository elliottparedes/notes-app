  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p v-if="publishedSpace" class="text-sm text-gray-500 dark:text-gray-400">
    ...
    <div v-else-if="error" class="flex-1 flex items-center justify-center">
      <div class="text-center">
        ...
        <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Space Not Found</h2>
        <p class="text-gray-600 dark:text-gray-400">{{ error }}</p>
      </div>
    </div>

    <!-- Main Content -->
    <div v-else-if="publishedSpace" class="flex-1 flex overflow-hidden">
      <!-- Sidebar - Folder Tree -->
      <aside class="w-80 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-800 overflow-y-auto">
        <div class="p-4 space-y-4">
          <!-- Root Level Notes -->
          <div v-if="publishedSpace.notes.length > 0" class="space-y-1">
          ...
          <!-- Folders -->
          <div v-if="publishedSpace.folders.length > 0" class="space-y-1">
            <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 px-2">
              Folders
            </h3>
            <PublishedFolderTree
          ...
          <!-- Empty State -->
          <div v-if="publishedSpace.folders.length === 0 && publishedSpace.notes.length === 0" class="text-center py-12">
